...
#########################################################
dsem.tt1[[4]] <- '
eta1t1 =~ ly1*y1t1 + ly2*y2t1 + ly3*y3t1+l7*y1t2
eta2t1 =~ ly4*y4t1 + ly5*y5t1 + ly6*y6t1
#
eta1t2 =~ ly1*y1t2 + ly2*y2t2 + ly3*y3t2+l7*y1t3
eta2t2 =~ ly4*y4t2 + ly5*y5t2 + ly6*y6t2
#
eta1t3 =~ ly1*y1t3 + ly2*y2t3 + ly3*y3t3+l7*y1t4
...
eta2t3 =~ ly4*y4t3 + ly5*y5t3 + ly6*y6t3
#
eta1t4 =~ ly1*y1t4 + ly2*y2t4 + ly3*y3t4+l7*y1t5
eta2t4 =~ ly4*y4t4 + ly5*y5t4 + ly6*y6t4
#
...
eta2t4 =~ ly4*y4t4 + ly5*y5t4 + ly6*y6t4
#
eta1t5 =~ ly1*y1t5 + ly2*y2t5 + ly3*y3t5+l7*y1t6
eta2t5 =~ ly4*y4t5 + ly5*y5t5 + ly6*y6t5
#
eta1t6 =~ ly1*y1t6 + ly2*y2t6 + ly3*y3t6+l7*y1t7
eta2t6 =~ ly4*y4t6 + ly5*y5t6 + ly6*y6t6
#
eta1t7 =~ ly1*y1t7 + ly2*y2t7 + ly3*y3t7+l7*y1t8
eta2t7 =~ ly4*y4t7 + ly5*y5t7 + ly6*y6t7
#
eta1t8 =~ ly1*y1t8 + ly2*y2t8 + ly3*y3t8+l7*y1t9
eta2t8 =~ ly4*y4t8 + ly5*y5t8 + ly6*y6t8
#
eta1t9 =~ ly1*y1t9 + ly2*y2t9 + ly3*y3t9+l7*y1t10
...
eta2t9 =~ ly4*y4t9 + ly5*y5t9 + ly6*y6t9
#
eta1t10 =~ ly1*y1t10 + ly2*y2t10 + ly3*y3t10+l7*y1t11
eta2t10 =~ ly4*y4t10 + ly5*y5t10 + ly6*y6t10
#
eta1t11 =~ ly1*y1t11 + ly2*y2t11 + ly3*y3t11+l7*y1t12
eta2t11 =~ ly4*y4t11 + ly5*y5t11 + ly6*y6t11
#
eta1t12 =~ ly1*y1t12 + ly2*y2t12 + ly3*y3t12+l7*y1t13
eta2t12 =~ ly4*y4t12 + ly5*y5t12 + ly6*y6t12
#
eta1t13 =~ ly1*y1t13 + ly2*y2t13 + ly3*y3t13+l7*y1t14
eta2t13 =~ ly4*y4t13 + ly5*y5t13 + ly6*y6t13
#
eta1t14 =~ ly1*y1t14 + ly2*y2t14 + ly3*y3t14+l7*y1t15
eta2t14 =~ ly4*y4t14 + ly5*y5t14 + ly6*y6t14
#
eta1t15 =~ ly1*y1t15 + ly2*y2t15 + ly3*y3t15
...
eta2t14 =~ ly4*y4t14 + ly5*y5t14 + ly6*y6t14
#
eta1t15 =~ ly1*y1t15 + ly2*y2t15 + ly3*y3t15+l7*y1t16
eta2t15 =~ ly4*y4t15 + ly5*y5t15 + ly6*y6t15
#
eta1t16 =~ ly1*y1t16 + ly2*y2t16 + ly3*y3t16+l7*y1t17
eta2t16 =~ ly4*y4t16 + ly5*y5t16 + ly6*y6t16
#
eta1t17 =~ ly1*y1t17 + ly2*y2t17 + ly3*y3t17+l7*y1t18
eta2t17 =~ ly4*y4t17 + ly5*y5t17 + ly6*y6t17
#
eta1t18 =~ ly1*y1t18 + ly2*y2t18 + ly3*y3t18+l7*y1t19
eta2t18 =~ ly4*y4t18 + ly5*y5t18 + ly6*y6t18
#
eta1t19 =~ ly1*y1t19 + ly2*y2t19 + ly3*y3t19+l7*y1t20
eta2t19 =~ ly4*y4t19 + ly5*y5t19 + ly6*y6t19
#
eta1t20 =~ ly1*y1t20 + ly2*y2t20 + ly3*y3t20+l7*y1t21
eta2t20 =~ ly4*y4t20 + ly5*y5t20 + ly6*y6t20
#
eta1t21 =~ ly1*y1t21 + ly2*y2t21 + ly3*y3t21+l7*y1t22
eta2t21 =~ ly4*y4t21 + ly5*y5t21 + ly6*y6t21
#
eta1t22 =~ ly1*y1t22 + ly2*y2t22 + ly3*y3t22+l7*y1t23
eta2t22 =~ ly4*y4t22 + ly5*y5t22 + ly6*y6t22
#
eta1t23 =~ ly1*y1t23 + ly2*y2t23 + ly3*y3t23+l7*y1t24
eta2t23 =~ ly4*y4t23 + ly5*y5t23 + ly6*y6t23
#
eta1t24 =~ ly1*y1t24 + ly2*y2t24 + ly3*y3t24+l7*y1t25
eta2t24 =~ ly4*y4t24 + ly5*y5t24 + ly6*y6t24
#
eta1t25 =~ ly1*y1t25 + ly2*y2t25 + ly3*y3t25+l7*y1t26
eta2t25 =~ ly4*y4t25 + ly5*y5t25 + ly6*y6t25
#
eta1t26 =~ ly1*y1t26 + ly2*y2t26 + ly3*y3t26+l7*y1t27
eta2t26 =~ ly4*y4t26 + ly5*y5t26 + ly6*y6t26
#
eta1t27 =~ ly1*y1t27 + ly2*y2t27 + ly3*y3t27+l7*y1t28
eta2t27 =~ ly4*y4t27 + ly5*y5t27 + ly6*y6t27
#
eta1t28 =~ ly1*y1t28 + ly2*y2t28 + ly3*y3t28+l7*y1t29
eta2t28 =~ ly4*y4t28 + ly5*y5t28 + ly6*y6t28
#
eta1t29 =~ ly1*y1t29 + ly2*y2t29 + ly3*y3t29+l7*y1t30
eta2t29 =~ ly4*y4t29 + ly5*y5t29 + ly6*y6t29
#
eta1t30 =~ ly1*y1t30 + ly2*y2t30 + ly3*y3t30
